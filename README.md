...
- Background 
 <p>차량 데이터를 활용해 연비와 배출량의 관계를 분석하고, 이를 기반으로 친환경적 차량 설계 (탄소 배출량 감축) 전략을 제안</p>

- Summary
	<p>(1). Data information <br/>
		- Fuel Consumption 2000-2022, 캐나다 모델별 연료 소비량 등급과 예상 이산화탄소 배출량 데이터</p>
		- 제품 제작 년도, 모델, 클래스, 엔진 사이즈, 연료 종류, 연비, 배출량 </p>
	<p>(2). Data Preprocessing <br/>
		- EDA (지점데이터 + 고객데이터 + 외부데이터) <br/>
		- Reduction ( 중복 행 제거 + 동일한 연비 정보를 제공하고 있는 컬럼 제거 )</p>
	<p>(3). Statistics, Visualization Insights <br/>
		- 데이터 상에서 2014~2015년 사이 배출량 데이터 값이 급격히 상승 <br/>
		- --> 2014 - 캐나다 연료 소모 가이드에 의하면, 2015년부터 차량 배출량과 연비가 10%~20% 정도 높게 책정되었음을 확인, 배출량 값을 15% 하향 </p>
